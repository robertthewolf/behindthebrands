      ...
      <Wrapper>
        ...
        <Helmet>
          <title>{post.frontmatter.name}</title>
            ...
            />
            <Container>
              <SuperHeading  dangerouslySetInnerHTML={{ __html: post.frontmatter.name.replace(/ /g, '<br/>') }}></SuperHeading>
...
query frontpageZhQuery {
  markdownRemark(frontmatter: {templateKey: { eq: "frontpagezh" }}) {
    html
    frontmatter {
      templateKey
      name
